...
public class customerTableController implements Initializable{
    ...
    private List getBestCustomersResultSet() throws SQLException{
        ...
        try{  
            ...
            String query = "{call SELECT_TOP_CUSTOMERS(?,?)}";
    ...
    @FXML
    public void setBestCustomers(){
        ObservableList<Customer> CustomersResultSet = null;
        try {
            CustomersResultSet = FXCollections.observableArrayList(getBestCustomersResultSet());
        } catch (SQLException ex) {
            Logger.getLogger(categoryTableController.class.getName()).log(Level.SEVERE, null, ex);
        }
